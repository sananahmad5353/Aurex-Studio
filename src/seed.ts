...
async function seed() {
  ...
  const settings = [
    ...
    { key: 'metaTitle', value: 'Aurex Studio - Digital Marketing Agency Pakistan' },
    { key: 'metaDescription', value: 'Aurex Studio is a leading digital marketing agency in Pakistan offering performance marketing, brand growth, lead generation, SEO, social media marketing, and e-commerce solutions. Based in Islamabad, serving clients nationwide.' },
